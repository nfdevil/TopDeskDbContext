...
{
    public partial class Voorziening
    {
        public Voorziening()
        {
        ...
        public int Reserveerbaareenheid { get; set; }
        public bool Reserveerbaarssd { get; set; }
        public bool Reserveerbaarlos { get; set; }
        public int Reserveerbaarlosvoor { get; set; }
        ...
        public Voorzieningsoort Soort { get; set; }
