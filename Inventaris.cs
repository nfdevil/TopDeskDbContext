...
{
    public class Inventaris : IVrijobject
    {
        public Inventaris()
        {
            ...
            InventarisOptionalgrid = new HashSet<InventarisOptionalgrid>();
            InverseSjabloonobject = new HashSet<Inventaris>();
        ...
        public Inventaris Sjabloonobject { get; set; }
        ...
        public ICollection<InventarisOptionalgrid> InventarisOptionalgrid { get; set; }
        public ICollection<Inventaris> InverseSjabloonobject { get; set; }
